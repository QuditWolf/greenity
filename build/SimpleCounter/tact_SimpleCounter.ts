...
export function loadSimpleCounter$Data(slice: Slice) {
    ...
    let _greenity = sc_0.loadUintBig(32);
    return { $$type: 'SimpleCounter$Data' as const, id: _id, counter: _counter, greenity: _greenity };
}

function loadTupleSimpleCounter$Data(source: TupleReader) {
    let _id = source.readBigNumber();
    let _counter = source.readBigNumber();
    let _greenity = source.readBigNumber();
    return { $$type: 'SimpleCounter$Data' as const, id: _id, counter: _counter, greenity: _greenity };
}
...
function storeTupleSimpleCounter$Data(source: SimpleCounter$Data) {
    ...
    builder.writeNumber(source.greenity);
    return builder.build();
}
...
async function SimpleCounter_init(id: bigint) {
    const __code = Cell.fromBase64('');
    const __system = Cell.fromBase64('');
...
const SimpleCounter_types: ABIType[] = [
    ...
    {"name":"SimpleCounter$Data","header":null,"fields":[{"name":"id","type":{"kind":"simple","type":"uint","optional":false,"format":32}},{"name":"counter","type":{"kind":"simple","type":"uint","optional":false,"format":32}},{"name":"greenity","type":{"kind":"simple","type":"uint","optional":false,"format":32}}]},
]
...
const SimpleCounter_getters: ABIGetter[] = [
    ...
    {"name":"greenity","arguments":[],"returnType":{"kind":"simple","type":"int","optional":false,"format":257}},
]

export const SimpleCounter_getterMapping: { [key: string]: string } = {
    'counter': 'getCounter',
    'id': 'getId',
    'greenity': 'getGreenity',
}
...
export class SimpleCounter implements Contract {
    ...
    async getGreenity(provider: ContractProvider) {
        let builder = new TupleBuilder();
        let source = (await provider.get('greenity', builder.build())).stack;
        let result = source.readBigNumber();
        return result;
    }
